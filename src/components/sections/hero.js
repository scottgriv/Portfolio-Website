...
const Hero = () => {
  ...
  const three = <h3 className="medium-heading">I connect people and business with technology.</h3>;
  const four = (
    <>
      <p>
        I’m a Software Engineer based in North Eastern Pennsylvania, USA. Currently, I work as a
